...
class Agent:
    def __init__(self, action_space_size = 4, visibility_range = 5, alpha = 0.1, gamma = 0.9, epsilon = 1.0, epsilon_decay = 0.995, min_epsilon = 0.01):
    ...
    def choose_action(self, state):
        ...
        # Use best known move at the current state
